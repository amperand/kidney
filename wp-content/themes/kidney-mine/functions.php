...
function wpb_adding_scripts() {	
	wp_register_script('foundation',get_stylesheet_directory_uri().'/js/foundation.min.js',array('jquery'), '1.0', true);
	wp_register_script('flexslide', get_stylesheet_directory_uri().'/js/jquery.flexslider-min.js', array('jquery'), '1.0', true);
	wp_register_script('actions',get_stylesheet_directory_uri().'/js/actions.js', array('jquery'), '1.0', true);
	
	wp_enqueue_script(array('foundation', 'flexslide', 'actions'));
...
function btnshortcode( $atts, $content = null ) {
   ob_start();
   echo '<a class="button round shortcode-btn" href="">' . do_shortcode($content) . '</a>';
   ?><script>
